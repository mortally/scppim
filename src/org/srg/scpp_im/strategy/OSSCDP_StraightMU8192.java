...
public class OSSCDP_StraightMU8192 extends SelfConfirmingDistributionPricePrediction {
	
	private static final long serialVersionUID = 100L;
	private static final int NUM_SAMPLE = 8192;
	
	public OSSCDP_StraightMU8192(int index)
	{
		super(index);
	}
