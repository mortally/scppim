...
public class OSSCDP_BidEvaluatorSMU_E64S256K4 extends
		SelfConfirmingDistributionPricePrediction {
	
	private static final long serialVersionUID = 100L;
	private static final int NUM_SAMPLE = 64;
	private static final int NUM_SCENARIO = 256;
	private static final int NUM_CANDIDATE_BID = 4;
	public static double bestCandidateUtil = 0;
	
	public OSSCDP_BidEvaluatorSMU_E64S256K4(int index)
	{
		super(index);
	}
	...
	private double[] sampleMV()
	{
		...
		UtilAnalyzer.bestCandidateUtil += bestUtil;
		if (PRINT_DEBUG)
		{
	...
	private static void addBestCandidateUtil(double bestUtil)
	{
		bestCandidateUtil += bestUtil;
	}
