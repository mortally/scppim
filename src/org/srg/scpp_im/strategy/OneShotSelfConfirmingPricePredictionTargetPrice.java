...
public class OneShotSelfConfirmingPricePredictionTargetPrice extends SelfConfirmingPricePrediction {
	
	private static final long serialVersionUID = 100L;
	
	public OneShotSelfConfirmingPricePredictionTargetPrice(int index)
	{
		super(index);
	}
