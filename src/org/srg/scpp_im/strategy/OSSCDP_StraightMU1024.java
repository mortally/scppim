...
public class OSSCDP_StraightMU1024 extends SelfConfirmingDistributionPricePrediction {
	
	private static final long serialVersionUID = 100L;
	private static final int NUM_SAMPLE = 1024;
	
	public OSSCDP_StraightMU1024(int index)
	{
		super(index);
	}
