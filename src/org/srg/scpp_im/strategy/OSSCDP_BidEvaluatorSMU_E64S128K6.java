...
public class OSSCDP_BidEvaluatorSMU_E64S128K6 extends
		SelfConfirmingDistributionPricePrediction {
	
	private static final long serialVersionUID = 100L;
	private static final int NUM_SAMPLE = 64;
	private static final int NUM_SCENARIO = 128;
	private static final int NUM_CANDIDATE_BID = 6;
	
	public OSSCDP_BidEvaluatorSMU_E64S128K6(int index)
	{
		super(index);
	}
