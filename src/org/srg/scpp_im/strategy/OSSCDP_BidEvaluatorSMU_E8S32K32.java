...
public class OSSCDP_BidEvaluatorSMU_E8S32K32 extends
		SelfConfirmingDistributionPricePrediction {
	
	private static final long serialVersionUID = 100L;
	private static final int NUM_SAMPLE = 8;
	private static final int NUM_SCENARIO = 32;
	private static final int NUM_CANDIDATE_BID = 32;
	
	public OSSCDP_BidEvaluatorSMU_E8S32K32(int index)
	{
		super(index);
	}
