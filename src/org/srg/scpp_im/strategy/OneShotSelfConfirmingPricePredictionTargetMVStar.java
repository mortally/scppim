...
public class OneShotSelfConfirmingPricePredictionTargetMVStar extends SelfConfirmingPricePrediction {
	
	private static final long serialVersionUID = 100L;
	
	public OneShotSelfConfirmingPricePredictionTargetMVStar(int index)
	{
		super(index);
	}
