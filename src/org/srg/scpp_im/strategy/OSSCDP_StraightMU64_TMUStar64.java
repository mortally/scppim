...
public class OSSCDP_StraightMU64_TMUStar64 extends SelfConfirmingDistributionPricePrediction {
	
	private static final long serialVersionUID = 100L;
	private static final int NUM_SAMPLE = 64;
	
	public OSSCDP_StraightMU64_TMUStar64(int index)
	{
		super(index);
	}
